    ...
    >
      ...
      <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
        <div className="flex justify-between items-start mb-2">
          <h4 className="font-bold text-green-800">Melhoria de Processo</h4>
          <span className="font-bold text-green-600 bg-white px-3 py-1 rounded-full shadow">
            120 XP
          </span>
        </div>
      ...
      <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
        <div className="flex justify-between items-start mb-2">
          <h4 className="font-bold text-green-800">Meta da Equipe</h4>
          <span className="font-bold text-green-600 bg-white px-3 py-1 rounded-full shadow">
            100 XP
          </span>
        </div>
      ...
      <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
        <div className="flex justify-between items-start mb-2">
          <h4 className="font-bold text-green-800">Resolução de Conflito</h4>
          <span className="font-bold text-green-600 bg-white px-3 py-1 rounded-full shadow">
            80 XP
          </span>
        </div>
      ...
      <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
        <div className="flex justify-between items-start mb-2">
          <h4 className="font-bold text-green-800">Facilitar Retrospectiva</h4>
          <span className="font-bold text-green-600 bg-white px-3 py-1 rounded-full shadow">
            60 XP
          </span>
        </div>
      ...
      <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
        <div className="flex justify-between items-start mb-2">
          <h4 className="font-bold text-green-800">Cultura da Equipe</h4>
          <span className="font-bold text-green-600 bg-white px-3 py-1 rounded-full shadow">
            50 XP
          </span>
        </div>
      ...
      <div className="border-l-4 border-green-500 pl-4 py-3 bg-green-50 rounded-r-lg">
        <div className="flex justify-between items-start mb-2">
          <h4 className="font-bold text-green-800">Documentação Útil</h4>
          <span className="font-bold text-green-600 bg-white px-3 py-1 rounded-full shadow">
            40 XP
          </span>
        </div>
