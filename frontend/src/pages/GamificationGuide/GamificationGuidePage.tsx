        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">
              Como Ganhar XP - Sistema Completo com Explicações
            </h2>
        ...
        >
          ...
          <div className="border-l-4 border-purple-500 pl-4 py-3 bg-purple-50 rounded-r-lg">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="font-bold text-purple-600 bg-white px-3 py-1 rounded-full shadow">
                25 XP
              </span>
            </div>
            <p className="text-purple-700 text-sm mb-2">
              <strong>Como funciona:</strong> Receber reconhecimento público de
              colegas por contribuição especial, seja técnica, cultural ou de
              liderança.
            </p>
            <div className="bg-white p-3 rounded border border-purple-200">
              <p className="text-xs text-purple-600">
                <strong>Exemplo:</strong> "Shoutout" em reunião de equipe por
                ajuda excepcional → 25 XP
              </p>
            </div>
          </div>
          ...
          <div className="border-l-4 border-purple-500 pl-4 py-3 bg-purple-50 rounded-r-lg">
            <div className="flex justify-between items-start mb-2">
              <h4 className="font-bold text-purple-800">Inovação</h4>
              <span className="font-bold text-purple-600 bg-white px-3 py-1 rounded-full shadow">
                100 XP
              </span>
            </div>
            <p className="text-purple-700 text-sm mb-2">
              <strong>Como funciona:</strong> Implementar solução criativa que
              gere impacto significativo em produtividade, qualidade ou
          ...
          <div className="border-l-4 border-gray-400 pl-4 py-3 bg-gray-50 rounded-r-lg">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="font-bold text-gray-600 bg-white px-3 py-1 rounded-full shadow">
                5-20 XP
              </span>
            </div>
            <p className="text-gray-700 text-sm">
              <strong>Como funciona:</strong> Participação em eventos da
              empresa, palestras externas, contribuições para comunidade técnica
              ou iniciativas de diversidade e inclusão.
            </p>
          </div>
        </XpCategory>
      </div>
