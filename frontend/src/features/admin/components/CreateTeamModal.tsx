        ...
        <form ref={formRef} onSubmit={submit} className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-surface-300 px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/60 focus:border-brand-500 bg-white/80"
            />
          </div>
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-surface-300 px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/60 focus:border-brand-500 bg-white/80"
            />
          </div>
          <div className="flex justify-end gap-2 pt-1">
            ...
            <button
              disabled={creating}
              className="inline-flex items-center justify-center bg-gradient-to-r from-brand-600 to-brand-700 text-white rounded-xl px-4 py-2 text-sm font-medium hover:from-brand-700 hover:to-brand-800 shadow-sm disabled:opacity-60"
            >
