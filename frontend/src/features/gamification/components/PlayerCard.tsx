      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="text-lg font-semibold text-surface-900">Player #{profile.userId.toString().padStart(3, "0")}</h3>
            ...
            <p className="text-sm text-surface-600 mb-2">• {getLevelTitle(profile.level)}</p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-surface-900">{profile.totalXP}</div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">XP Total</div>
          </div>
          <div className="text-center border-l border-r border-surface-200 px-4">
            <div className="text-2xl font-bold text-surface-900">{profile.badges.length}</div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">Milestones</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-surface-900">{profile.rank || 0}</div>
            <div className="text-xs text-surface-500 uppercase tracking-wide">Key Results</div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="text-surface-500">{Math.round(progressPercentage)}%</span>
          </div>
