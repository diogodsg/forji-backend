...
import {
  svgAvatarOptions,
  svgAvatarCategories,
  type SVGAvatarOption,
} from "../data/svgAvatars";

interface SVGAvatarSelectorProps {
...
export function SVGAvatarSelector({
  currentAvatar,
  onSelectAvatar,
  onClose,
  isOpen,
}: SVGAvatarSelectorProps) {
        ...
        <div className="flex items-center justify-between p-6 border-b border-surface-200">
          <div>
            ...
            <p className="text-sm text-surface-600 mt-1 font-medium">
              Selecione um avatar vetorial que represente você
            </p>
          </div>
          <button
            onClick={onClose}
